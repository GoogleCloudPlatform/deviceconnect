- dashboard: acute_care_prepost
  title: Acute Care (Pre/Post)
  layout: newspaper
  ...
  - title: Untitled
    ...
    defaults_version: 1
    listen:
      Days From Surgery: activity_summary.surgery_date_diff
  ...
  - title: Steps Time-Series
    ...
    filters:
      activity_summary.date_granularity: Day
  ...
  - title: Activity Minutes Time-Series
    ...
    filters:
      heart_rate_zones.date_granularity: Day
  ...
  - title: Weight Time-Series
    ...
    filters:
      body_weight.date_granularity: Day
  ...
  - title: Current BMI
    ...
    dynamic_fields: [{measure: average_of_weight, based_on: body_weight.weight, expression: '',
        label: Average of Weight, type: average, _kind_hint: measure, _type_hint: number},
      {measure: average_of_bmi, based_on: body_weight.bmi, expression: '', label: Average
          of Bmi, type: average, _kind_hint: measure, _type_hint: number}]
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: Sleep Time-Series
    ...
    filters:
      sleep_summary.date_granularity: Day
  ...
  - title: Time Wearing Fitbit
    ...
    height: 3
  filters:
  - name: Days From Surgery
    title: Days From Surgery
    type: field_filter
    default_value: "[-14,30]"
    ...
    explore: activity_summary
    listens_to_filters: []
    field: activity_summary.surgery_date_diff
  - name: User Full Name
