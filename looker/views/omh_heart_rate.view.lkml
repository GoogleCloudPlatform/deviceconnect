# The name of this view in Looker is "Omh Heart Rate"
view: omh_heart_rate {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `starterkit-344119.fitbit.omh_heart_rate`
    ;;
  drill_fields: [id]
  ...
  # This dimension will be called "Body Effective Time Frame Time Interval Duration Unit" in Explore.
  ...
  dimension: body_heart_rate_unit {
    type: string
    sql: ${TABLE}.body_heart_rate_unit ;;
  }

  dimension: body_heart_rate_value {
    type: number
    sql: ${TABLE}.body_heart_rate_value ;;
  }
