# The name of this view in Looker is "Omh Intraday Steps"
view: omh_intraday_steps {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `starterkit-344119.fitbit.omh_intraday_steps`
    ;;
  drill_fields: [id]
  ...
  dimension: body_step_count {
    type: string
    sql: ${TABLE}.body_step_count ;;
  }
